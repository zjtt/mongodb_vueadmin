<template>
	<section>
		...
		<div class="box-card"  v-if="!alreadyApply" style="text-align:center;">
			<br /><br /><h2>您还没有已应聘信息</h2>
		</div>
	</section>
</template>
	...
	export default {
		...
		methods:{
			...
			getData() {
				...
				get('/api/person/alreadyApply',this.getPara).then((response) => {//请求成功
